    ...
    <div class='left-column'>
        ...
        <div class="card">        
            <div class="container">       
                ...
                <p class="label-small"><i class="far fa-dot-circle"></i> Decide, architect, and implement technology decisions to best drive business and technology forward<br/>
                <i class="far fa-dot-circle"></i> Migrate Ace’s legacy ERP system, TakeStock, to a modern ERP (NetSuite)<br/>
                <i class="far fa-dot-circle"></i> Implement ETL paths for ERP data from old ERP into new ERP system<br/>
                <i class="far fa-dot-circle"></i> Refactor legacy .Net dispatchers board (technician scheduling) into Single page Django application<br/>
                <i class="far fa-dot-circle"></i> Migrate legacy software off Azure to AWS for consolidation of costs<br/>
                <i class="far fa-dot-circle"></i> Design and implement new Django customer portal application for existing customer base<br/>
                <i class="far fa-dot-circle"></i> Support migration of AspDotNet Storefront to a modern eCommerce platform (BigCommerce)<br/>
                <i class="far fa-dot-circle"></i> Add features and maintain Ace’s objective-C iPhone mobile app<br/>
                <i class="far fa-dot-circle"></i> Build and configure resources in AWS</p>
            </div>        
        </div>
        <div class="card">        
            <div class="container">       
                ...
                <div class="experience-header">
                    <p class="label-small">Development lead in charge of architecture, implementation, and maintenance of the Connector Framework. This framework is used to feed data sources into Accent’s analytics engine. Most notably Microsoft Exchange and Salesforce CRM.</p>
                </div>
                ...
                <i class="far fa-dot-circle"></i> Refactor microservice orchestrator architecture into an event stream reactive architecture<br/>
